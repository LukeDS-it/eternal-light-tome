  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        FolkListView.ROUTE: (context) => FolkListView(context),
        NoteListView.ROUTE: (context) => NoteListView(context)
      },
    );
  }
}
